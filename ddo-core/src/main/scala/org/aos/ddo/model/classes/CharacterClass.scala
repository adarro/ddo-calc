...
object CharacterClass extends Enum[CharacterClass] with SearchPrefix {

  /**
    *
    * The [http://ddowiki.com/page/Artificer Artificer] combines magic with weapon technology and skill. Traditionally, Artificers prefer to avoid getting their hands dirty in a fight, using personally-made constructs that perform a variety of tasks but are especially capable in combat. Artificers are a jack-of-all-trades class: they can serve as excellent healers, decent offensive spellcaster, ranged combatants, and many more roles. Artificers gain Intelligence enhancements as they level up.
    * The Artificer class must either be purchased in the DDO Store for DDO Points or unlocked on a per-server basis by earning 150 House Cannith favor on a single character.
    */
  case object Artificer extends CharacterClass
  ...
  /**
    ...
    */
  case object Barbarian extends CharacterClass
  ...
  /**
    ...
    */
  case object Bard extends CharacterClass
  ...
  /**
    ...
    */
  case object Druid extends CharacterClass
  ...
  /**
    ...
    *
    */
  case object FavoredSoul extends CharacterClass
  ...
  /**
    ...
    * .
    */
  case object Paladin extends CharacterClass
  ...
  /**
    ...
    */
  case object Ranger extends CharacterClass
  ...
  /**
    ...
    */
  case object Rogue extends CharacterClass
  ...
  /**
    ...
    */
  case object Warlock extends CharacterClass
  ...
  override def values: Seq[CharacterClass] = findValues
