...
/**
  ...
  * 13 Charisma
  */
protected[feat] trait HalfElfDilettanteWarlock extends FeatRequisiteImpl with HalfElfDilettante with Passive with RequiresAttribute with RequiresAllOfRace {
  self: Feat =>
