...
/** Icon Feat Improved Shield Mastery.png
  ...
  * Base Attack Bonus +8
  * */
protected[feat] trait ImprovedShieldMastery extends FeatRequisiteImpl with Passive with RequiresAllOfFeat with RequiresBaB {
  self: Feat =>
  override def allOfFeats: Seq[Feat] = List(Feat.ShieldMastery)
