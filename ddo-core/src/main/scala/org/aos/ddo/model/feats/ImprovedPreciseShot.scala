...
/** Icon Feat Improved Precise Shot.png
  ...
  */
protected[feats] trait ImprovedPreciseShot extends FeatRequisiteImpl with Active with RequiresAllOfFeat with RequiresAttribute with RequiresBaB {
  self: GeneralFeat =>
  override def allOfFeats: Seq[GeneralFeat] = List(GeneralFeat.PointBlankShot, GeneralFeat.PreciseShot)
