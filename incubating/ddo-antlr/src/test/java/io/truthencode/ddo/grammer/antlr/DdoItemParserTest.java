...
//            String msg = String.format("dn:\t%s\rsn:\t%s\rln:\t%s", dn, sn, ln);
    ...
    void walkText(String data, ParseTreeListener listener) {
        ...
        io.truthencode.ddo.grammer.antlr.EnchantmentsLexer lexer = new io.truthencode.ddo.grammer.antlr.EnchantmentsLexer(CharStreams.fromString(data));

        CommonTokenStream tokens = new CommonTokenStream(lexer);
        io.truthencode.ddo.grammer.antlr.EnchantmentsParser parser = new io.truthencode.ddo.grammer.antlr.EnchantmentsParser(tokens);
