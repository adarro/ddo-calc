...
public class PulsarContainerTest {
    ...
    private static final DockerImageName PULSAR_IMAGE = DockerImageName.parse(
    ...
    public void shouldNotEnableFunctionsWorkerByDefault() throws Exception {
        try (PulsarContainer pulsar = new PulsarContainer(PULSAR_IMAGE)) {
            ...
            assertThrows(
                ...
                () -> pulsarAdmin.functions().getFunctions("public", "default")
            );
        }
    }
    ...
    public void shouldWaitForFunctionsWorkerStarted() throws Exception {
        try (
            ...
            PulsarContainer pc = pulsar.withFunctionsWorker()
        ) {
            pc.start();
            ...
            int s = pulsarAdmin
                .functions()
                .getFunctions("public", "default")
                .size();
            assertEquals(s, 0);
        }
    }

    protected void testPulsarFunctionality(String pulsarBrokerUrl)
        throws Exception {
        try (
