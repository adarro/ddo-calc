...
object EffectCategories extends Enumeration {
  ...
  /**
   * Your ability stat (Strength, Charisma etc) Not super useful by itself, but indicates the effect
   * provides an ability. The power and extent of that ability may depend on other things. Examples
   * may include Bard Songs, Sunder, Attack etc.
   */
  Ability,
