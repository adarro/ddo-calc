 ...
 *
 * Author: Andre White.
 * FILE: HitChanceAmountFeature.scala
 *
 ...
 */
trait HitChanceAmountFeature extends Features {
  self: SourceInfo =>
  ...
  protected val hitChanceCategories: Seq[effect.EffectCategories.Value]
  ...
  private val hitChanceChance =
    new PartModifier[Int, BasicStat] with UsingSearchPrefix {
       ...
       */
      override val generalDescription: String = "Increases your Chance to Hit"
