 ...
 *
 * Author: Andre White.
 * FILE: HitPointPerLevelAmountFeature.scala
 *
  ...
  private val hitPointAmount =
    new PartModifier[Int, BasicStat] with DynamicFeature[Int] with UsingSearchPrefix {
      ...
      override val generalDescription: String =
        "Increases your Total Hit Points by a certain amount per level"
       ...
       */
      override def categories: Seq[String] = hitPointPerLevelCategories.map(_.toString)
