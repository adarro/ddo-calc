 ...
 *
 * Author: Andre White.
 * FILE: EfficientMetamagicsII.scala
 *
...
import io.truthencode.ddo.core.model.enhancement.enhancements.classbased.BombardierTierThree
import io.truthencode.ddo.core.support.naming.RomanNumeralAffix
