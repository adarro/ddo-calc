...
import io.truthencode.ddo.model.enhancement.enhancements.classbased.{
  VileChemistTierFour,
  VileChemistTierThree
}
import io.truthencode.ddo.support.StringUtils.Extensions
import io.truthencode.ddo.support.points.SpendablePoints
import io.truthencode.ddo.support.tree.TreeLike

trait HiddenBladesIII extends VileChemistTierFour with ClassEnhancementImpl {
  // Will Save +1

  override lazy val description: Option[String] = Some("""+5 Universal Spell Power, +3% Doublestrike and Doubleshot, +1 bonus Imbue Dice.
  ...
  override protected def nameSource: String = "Hidden Blades III".replaceRomanNumerals
