 ...
 *
 * Author: Andre White.
 * FILE: SpellCriticalChancePositiveAndNegativeII.scala
 *
...
import io.truthencode.ddo.core.model.enhancement.enhancements.classbased.ApothecaryTierTwo
...
trait SpellCriticalChancePositiveAndNegativeII
  extends ApothecaryTierTwo with ClassEnhancementImpl with SpellCriticalChancePrefix {
