 ...
 *
 * Author: Andre White.
 * FILE: SpellCriticalChancePositiveAndNegativeIV.scala
 *
...
import io.truthencode.ddo.core.model.enhancement.enhancements.classbased.ApothecaryTierFour
...
trait SpellCriticalChancePositiveAndNegativeIV
  extends ApothecaryTierFour with ClassEnhancementImpl with SpellCriticalChancePrefix {
