...
trait BelovedLevelBase
  extends ReligionFeatBase with Passive with RequiresAllOfClass with BelovedOfLevel {
  self: FavoredWeapon & RequiresAllOfFeat =>
  // FIXME: empty call needs to be placed on Class Requirements
