...
/**
 * Icon Feat Brutal Throw.png Brutal Throw Passive
 *
 * You can use your Strength bonus instead of the Dexterity bonus to determine a bonus to attack
 * with Thrown weapons if it is higher.
 *
