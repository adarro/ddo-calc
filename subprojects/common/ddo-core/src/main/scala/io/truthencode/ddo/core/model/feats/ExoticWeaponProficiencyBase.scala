...
import io.truthencode.ddo.core.model.item.weapon.ExoticWeapon
 ...
 * @note
 *   Dwarven Waraxe can be auto-granted as to Dwarves if they possess the full martial weapon grant
