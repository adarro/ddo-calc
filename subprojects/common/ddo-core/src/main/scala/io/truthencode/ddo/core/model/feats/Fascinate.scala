 ...
 * This song fascinates most nearby living (not oozes, undead, or constructs, unless core
 * spellsinger enhancement has been acquired) enemies, causing them to cease their activities until
 * they're damaged or the effect ends. Fascinated enemies are also vulnerable to charming by
 * Suggestion Song and Mass Suggestion Song.
 * @note
