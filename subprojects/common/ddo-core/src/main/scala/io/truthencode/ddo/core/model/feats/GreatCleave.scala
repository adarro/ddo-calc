...
import io.truthencode.ddo.core.model.misc.CoolDownPool.GreatCleave
...
trait GreatCleave
  ...
  with ActiveFeat with AtWillEvent with SharedCoolDown with RequiresAllOfFeat with RequiresBaB
