 ...
 * Fighting bonus is increased to a +30% Combat Style bonus to attack speed and 2 additional Mêlée
 * Power (for a total of 6) and 50% more of your appropriate ability score to your damage (similar
 * to Two-Handed Fighting).
 *
 * Note: Further increases the base number of attacks per second from 1.8 to 2.0.[Unverified]
 * Improved Single Weapon Fighting 7 ranks of Balance Base Attack Bonus +11
 */
