...
import io.truthencode.ddo.core.enhancement.BonusType.Feat
import io.truthencode.ddo.core.model.effect
import io.truthencode.ddo.core.model.effect.TriggerEvent.{Never, Passive}
import io.truthencode.ddo.core.model.effect.features.{
  Features,
  FeaturesImpl,
  TurnUndeadCasterLevelFeature
}
import io.truthencode.ddo.core.model.effect.{EffectCategories, Feature, SourceInfo, TriggerEvent}
