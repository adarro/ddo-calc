...
import io.truthencode.ddo.core.model.misc.CoolDownPool.ManyShot
...
/**
 * Icon Feat Ten Thousand Stars.png [Ten Thousand Stars Active - Ability For the
 * next](https://ddowiki.com/page/Ten_Thousand_Stars) 30 seconds, add your Wisdom ability score to
 * your Ranged Power and add your monk level * 5 to your Doubleshot. This ability puts Manyshot on a
 * 30-second cooldown. Cooldown: one minute.
 * @note
