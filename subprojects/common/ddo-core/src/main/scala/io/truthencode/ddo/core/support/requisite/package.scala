...
import io.truthencode.ddo.core.CharacterLevels
import io.truthencode.ddo.core.model.alignment.{AlignmentType, Alignments}
...
//        }
  ...
  def classToReq(hc: (HeroicCharacterClass, Int)*): Seq[ReqClass] = {
    hc.map { h =>
