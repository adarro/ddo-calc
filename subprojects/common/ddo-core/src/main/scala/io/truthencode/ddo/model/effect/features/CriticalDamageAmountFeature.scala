  ...
  private[this] val criticalDamageAmount =
    new PartModifier[Int, BasicStat]  with UsingSearchPrefix {
      ...
      lazy override protected[this] val partToModify: BasicStat =
         ...
         * share that value. I.e. a Dodge Effect might state it increases your miss-chance, but omit any value such as 20%.
         * Those values will be displayed in the effectText of a specific implementation such as the Dodge Feat or Uncanny
         * Dodge
         */
         ...
         * desired effects.
         *
         * This list might be constrained or filtered by an Enumeration or CSV file. The goal is to enable quick and advanced
         * searching for specific categories from general (Miss-Chance) to specific (evasion). In addition, it may be useful
         * for deep searching such as increasing Spot, which should suggest not only +Spot items, but +Wisdom or eventually
         * include a feat or enhancement that allows the use of some other value as your spot score.
         */
