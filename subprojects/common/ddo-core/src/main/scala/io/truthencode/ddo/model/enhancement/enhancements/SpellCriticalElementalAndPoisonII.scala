...
trait SpellCriticalElementalAndPoisonII extends BombardierTierTwo with ClassEnhancementImpl with SpellCriticalPrefix {
  override protected def nameSource: String = "Elemental And Poison II".replaceRomanNumerals.lowerCaseNoise
  /**
