...
import io.truthencode.ddo.model.effect.features.{Features, FeaturesImpl, TurnUndeadNumberOfTurnsFeature}
...
trait ExtraTurning
  ...
  val si = this
  private val undeadTurnsFeature = new FeaturesImpl with TurnUndeadNumberOfTurnsFeature with SourceInfo {
