...
/**
 * [[http://ddowiki.com/page/Fast_Movement_(monk_class_feat)]] A Monk gains a cumulative 5% bonus to run speed while
 * centered for every three Monk levels. This bonus stacks with other run speed bonuses. If the monk would become
 * uncentered (by equipping armor, or wielding non-monk weapons, etc) then the bonuses are temporarily lost.
 */
