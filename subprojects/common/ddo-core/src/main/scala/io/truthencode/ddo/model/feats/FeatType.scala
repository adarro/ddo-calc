...
/**
  * This is a tactical Feat such as Trip and Stunning Blow which can generally be affected by things such as Combat Mastery
  */
...
protected[feats] trait SpellCastingActive
    extends EpicFeatCategory
    with ActiveFeat {
  self: ActiveEvent =>
}
