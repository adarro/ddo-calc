...
/**
 * Warlock.png Half-Elf Dilettante: Warlock Passive Able to use wands and scrolls as if you were a level one warlock.
 * Toggle: You deal 1D4 extra Fire damage with attacks and spells. This trigger at most once every two seconds. This
 * toggle is exclusive with Warlock Pact toggles. Half-Elf 13 Charisma
 */
