...
/**
  * [[https://ddowiki.com/page/Improved_Inspire_Courage Improved Inspire Courage]]
  * Level: Bard 8
  * Perform: 3 ranks*
  * Target: Bard and all nearby allies
  * Base Duration: 4 minutes
  * Song Description: Gives a +2 (total) morale bonus to attack rolls, damage rolls, and saving throws versus fear. At Bard level 14, these bonuses rise to +3, and at Bard level 20 they rise to +4.
  * Notes:
  * Each of these bonuses can be raised through Warchanter enhancements (maximum +3) and the Fatesinger epic destiny.
  * The song's duration can be raised through Spellsinger enhancements (+60% lingering song, +20% core ability), Fatesinger epic destiny, and Lasting Inspiration epic feat.
