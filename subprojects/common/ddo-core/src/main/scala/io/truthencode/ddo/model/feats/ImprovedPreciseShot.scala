...
/** Icon Feat Improved Precise Shot.png
  * [[https://ddowiki.com/page/Improved_Precise_Shot Improved Precise Shot]]
  ...
  *
  * Notes
  * A ranger gets this feat for free at level 11, even if he does not meet the prerequisites.
  ...
  * Tips:
  *
  * Offensive Ranged Stance: Incompatible with Archer's Focus.
  * Many special attacks, even those that usually affect only a single target, can affect all enemies in the path.
  * The projectile continues beyond your selected target.
  * Race height matters. Tall races, such as Bladeforged, shoot their projectiles from a higher elevation.
  * When targeting smaller enemies, projectile travels downwards and often harmlessly flies above the head of nearby enemies.
  * Targeting is easier for smaller races, particularly Halflings.
  */
