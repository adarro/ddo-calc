...
/**
  * [[https://ddowiki.com/page/Inspire_Greatness Inspire Greatness]]
  * Level: Bard 9
  * Perform: 12 ranks*
  * Target: Bard and all nearby allies
  * Base Duration:
  * Song Description:
  * Allies and yourself benefit from +20 Temporary Hit Points, +3 Physical Resistance Rating,
  * an +10 Healing Amplification as long as your are not incapacitated and they are within the Ballad.
  * Notes:
  * This song now included in your Bardic Ballad.
  ...
  * @todo Add not incapacitated flag
  */
