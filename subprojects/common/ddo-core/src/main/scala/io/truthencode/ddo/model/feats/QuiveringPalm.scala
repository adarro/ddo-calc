...
/**
  * [[https://ddowiki.com/page/Quivering_Palm Quivering Palm]]
  ...
  *       Whenever an enemy saves vs. Quivering Palm, you get a stacking +4 bonus to your Quivering Palm DC.
  *       This stack is dispelled when you successfully kill someone with Quivering Palm (or 3 minutes pass).
  *       @todo Some Tactical bonuses are confirmed not working So not sure if flagging this tactical is accurate programmatically
  */
trait QuiveringPalm
