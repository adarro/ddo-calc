...
/**
 * Icon Feat Improved Shield Bash.png Shield Deflection Passive When actively blocking with any type of Shield you are
 * proficient with, you gain a Competence bonus based on the type of shield to completly ignore Acid, Cold, Electic and
 * Fire damage.
 *
