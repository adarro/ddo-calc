...
/**
 * Used to determine if a given feat can be taken multiple times Feats that do not posses this trait can only be taken
 * once. Feats which have this trait but do not specify a value [Option.None] are considered unlimited.
