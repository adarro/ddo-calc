 ...
 *
 * Author: Andre White.
 * FILE: WildShapeWaterElemental.scala
 *
 ...
 */
trait WildShapeWaterElemental extends WildShape with GrantsToClass with RequiresAllOfClass {
  self: DisplayName & DisplayProperties =>

  override def grantToClass: Seq[(HeroicCharacterClass, Int)] =
    List((Druid, 13), (Druid, 17))

  override def allOfClass: Seq[(HeroicCharacterClass, Int)] = List((Druid, 13))
}
