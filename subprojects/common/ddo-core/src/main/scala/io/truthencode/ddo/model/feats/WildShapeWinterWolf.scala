 ...
 *
 * Author: Andre White.
 * FILE: WildShapeWinterWolf.scala
 *
 ...
 */
trait WildShapeWinterWolf extends WildShape with GrantsToClass with RequiresAllOfClass {
  self: DisplayName & DisplayProperties =>

  override def grantToClass: Seq[(HeroicCharacterClass, Int)] =
    List((Druid, 8), (Druid, 11))

  override def allOfClass: Seq[(HeroicCharacterClass, Int)] = List((Druid, 8))
}
