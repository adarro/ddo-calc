...
/**
 * Represents weapons that can be thrown such as throwing daggers, throwing hammers and throwing stars.
 */
...
/**
 * This trait indicates Damage is delivered in a non-standard way and may require some custom processing.
 */
