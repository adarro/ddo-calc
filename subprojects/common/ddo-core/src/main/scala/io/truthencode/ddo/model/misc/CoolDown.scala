...
trait DefaultSpellCoolDown extends CoolDown {
  ...
  /**
    * @todo this needs to be a class based filter as the default depends on it.
    * @return
    */
...
/**
  ...
  * @todo Need to see if Warlocks are in this category
  */
...
trait BardSongCoolDown extends CoolDown {
  ...
  /**
    * This is a temporary and arbitrary cooldown assuming aura bard songs have a timer.
    * Typically, aside from instant songs, the cool down will expire well before the song finishes.
    */
