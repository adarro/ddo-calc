...
import io.truthencode.ddo.activation.{ActivationType, ActivationTypeImpl, AtWillEvent, PassiveActivation, TriggeredActivationImpl}
...
object Skill extends Enum[Skill] with SearchPrefix {
   ...
   */
  case object Balance extends Skill with TriggeredActivationImpl with PassiveActivation with DexterityLinked
   ...
   */
  case object Concentration extends Skill with ActivationTypeImpl with PassiveActivation with ConstitutionLinked
   ...
   */
  case object Diplomacy extends Skill with TriggeredActivationImpl with AtWillEvent with CharismaLinked
   ...
   * tool.
   */
  case object DisableDevice extends Skill with TriggeredActivationImpl with AtWillEvent with IntelligenceLinked

  /**
   * Allows you to negotiate better prices with vendors.
   */
  case object Haggle extends Skill with ActivationTypeImpl with PassiveActivation with CharismaLinked
   ...
   */
  case object Intimidate extends Skill with TriggeredActivationImpl with AtWillEvent with CharismaLinked
   ...
   * Sneak.
   */
  case object OpenLock extends Skill with TriggeredActivationImpl with AtWillEvent with DexterityLinked

  /**
   * Allows you to sneak past monsters, avoiding their hearing. It ties directly into the feat
   * Sneak.
   */
  case object MoveSilently extends Skill with ActivationTypeImpl with PassiveActivation with DexterityLinked
   ...
   * Sonic Spell Power.
   */
  case object Perform extends Skill with ActivationTypeImpl with PassiveActivation with CharismaLinked
   ...
   */
  case object Repair extends  Skill with TriggeredActivationImpl with PassiveActivation with AtWillEvent with IntelligenceLinked
   ...
   */
  case object Search extends  Skill with TriggeredActivationImpl  with AtWillEvent with IntelligenceLinked

  /**
   * Adds 1 point of Spell Power per point of skill with following damage types: Acid, Cold,
   * Electric, Fire, Force and Light.
   */
  case object Spellcraft extends  Skill with ActivationTypeImpl with PassiveActivation with IntelligenceLinked
   ...
   */
  case object Tumble extends  Skill with ActivationTypeImpl with PassiveActivation with DexterityLinked
   ...
   */
  case object UseMagicDevice extends  Skill with ActivationTypeImpl with PassiveActivation with CharismaLinked
}
