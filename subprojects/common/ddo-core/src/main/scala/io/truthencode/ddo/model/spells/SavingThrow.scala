 ...
 *   + (any relevant items and or buffs). (Intelligence for a Wizard, Charisma for a Sorcerer or Bard, and Wisdom for a
 *   Cleric, Favored Soul, Paladin, or Ranger.) A spell's level can vary depending on your class. Always use the spell
