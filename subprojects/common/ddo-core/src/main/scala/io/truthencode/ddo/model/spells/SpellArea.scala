...
object SpellArea extends Enum[SpellArea] {
  ...
  /**
    * A cone-shaped spell shoots away from you in a quarter-circle centered on your target.
    * Listed as "Conal AOE" in spell descriptions.
    */
  case object Cone extends SpellArea

  /**
    * A line-shaped spell shoots away from you in a line in the direction you designate.
    * A line-shaped spell affects all valid targets that the line passes through.
    */
  case object Line extends SpellArea

  /**
    * A sphere-shaped spell expands from its point of origin to fill a spherical area.
    * Listed as "Spherical AOE" in spell descriptions.
    */
