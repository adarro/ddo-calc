 ...
 */
sealed trait SpellPower extends EnumEntry with DisplayName with FriendlyDisplay with SkillLinkedPower {
  /**
...
object SpellPower extends Enum[SpellPower] with SearchPrefix {
  ...
  /**
   * Force power also affects your untyped and physical damage spells (such as the bludgeoning portion of ice storm)
   */
  ...
  /**
   * Poison spell power is affected by negative enchantments such as Nihil and your Spellsight / Spellcraft Skill
   */
