...
/**
  * Represents the general health or Life.
  * Players are incapacitated when this falls below zero and die if it falls too far into the negative.
  */
