...
trait AlignmentRequisite {
  ...
  /**
    ...
    * @return Required Alignments
    *         @note This implementation may change as there can be at most two required alignment parts, one from each
    *               axis.
    */
  ...
  /**
    ...
    *         @note implementation may change as you can have only one alignment combination
    */
