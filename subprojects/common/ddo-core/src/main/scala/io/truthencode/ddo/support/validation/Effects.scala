...
def validateDetailedEffect(
                              ...
                              bonusType: String,
                              scaling: Option[Seq[ScalingInfo]])(using filterStrategy: invalidationOptions): Validation[String, DetailedEffect] =
    Validation.validateWith(
        ...
        validateScalingPower(scaling))(DetailedEffect.apply)