...
import io.truthencode.ddo.core.StringUtils.{Extensions, StringImprovements}
...
class StringUtilsTest
  ...
  describe("StringImprovements") {
    it("implicitly allows safe string to int conversions") {
      import io.truthencode.ddo.core.StringUtils.StringImprovements // scalastyle:off import.grouping due to implicit scoping
